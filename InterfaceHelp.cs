...
internal static class InterfaceHelp
{
    private static readonly IReadOnlyDictionary<string, string> ButtonHelp =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Configure router"] = "Open protected local router setup: address, monitoring switch and Windows-protected password storage.",
            ["Reconnect now"] = "Retry the local TP-Link login and immediately refresh router telemetry.",
            ["Reconnect"] = "Retry the local TP-Link login and immediately refresh router telemetry.",
            ...
            ["Show router / line details"] = "Expand router-level LTE telemetry or line placeholders for the selected access technology.",
            ["Hide router / line details"] = "Collapse the detailed router/line cards while keeping the access selector and connection state visible.",
    ...
    private static readonly IReadOnlyDictionary<string, string> ColumnHelp =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Score"] = "Independent RF score from measured SINR/SNR (50%), RSRQ (35%) and signal power RSRP (15%) for this time period. Hover an RF value to see the measured Signal, SINR/SNR, RSRQ and RSRP values. RF does not affect Rank.",
